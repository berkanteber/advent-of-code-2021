...
def solve(data: str) -> int:
    ...
    all_beacons = set()
    for i, (loc, rot_count) in scanners.items():
        loc_x, loc_y, loc_z = loc
        for beacon in scanner_beacons[i]:
            x, y, z = rotate(beacon, rot_count)
            all_beacons.add((loc_x + x, loc_y + y, loc_z + z))
...
assert solve(example_data) == 79

print(solve(data))  # 396
